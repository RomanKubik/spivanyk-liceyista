...
class SongModule(private val activity: SongActivity) {
    ...
    @Provides
    @ActivityScope
    fun getPresenter(songInteractor: SongInteractor, favouriteInteractor: FavouriteInteractor): SongContract.Presenter {
        return SongPresenter(activity, songInteractor, favouriteInteractor)
    }
}
