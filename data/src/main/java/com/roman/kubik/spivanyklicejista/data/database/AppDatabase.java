...
import com.roman.kubik.spivanyklicejista.data.history.HistoryDao;
import com.roman.kubik.spivanyklicejista.data.history.HistoryEntity;
 ...
 */
@Database(entities = {SongEntity.class, CategoryEntity.class, FavouriteEntity.class, HistoryEntity.class}, version = 2)
