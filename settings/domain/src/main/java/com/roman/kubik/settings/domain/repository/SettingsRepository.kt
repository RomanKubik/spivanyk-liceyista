...
class SettingsRepository @Inject constructor(private val preferenceService: PreferenceService, private val themeService: ThemeService) {
    ...
    suspend fun updatePreferences(preferences: Preferences) {
        if (preferenceService.getPreferences().uiMode != preferences.uiMode) {
